...
import { RolePermissionRepository } from "@/repositories/admin/RolePermissionRepository";
...
export async function createRole(
    ...
    if (await service.existsByCode(data.code)) {
        throw new Error("Role code already exists.");
    }

    if (await service.existsByName(data.name)) {
